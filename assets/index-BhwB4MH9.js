...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ja(e,t,n){let r=new Float32Array(_a),i=new J(0,1,0);return new ni({name:`SphericalGaussianBlur`,defines:{n:_a,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Pa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ma(){return new ni({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Pa(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Na(){return new ni({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Pa(),fragmentShader:`
	...
	`}var Fa=class extends Ct{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Rr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var ss={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function cs(e,t){let n=ss[t];return n===void 0?(U(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ls=new J;function us(){return X.getLuminanceCoefficients(ls),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ls.x.toFixed(4)}, ${ls.y.toFixed(4)}, ${ls.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
#define LOW_PRECISION`),t}var Ts={1:`SHADOWMAP_TYPE_PCF`,3:`SHADOWMAP_TYPE_VSM`};function Es(e){return Ts[e.shadowMapType]||`SHADOWMAP_TYPE_BASIC`}var Ds={301:`ENVMAP_TYPE_CUBE`,302:`ENVMAP_TYPE_CUBE`,306:`ENVMAP_TYPE_CUBE_UV`};function Os(e){return e.envMap===!1?`ENVMAP_TYPE_CUBE`:Ds[e.envMapMode]||`ENVMAP_TYPE_CUBE`}var ks={302:`ENVMAP_MODE_REFRACTION`};function As(e){return e.envMap===!1?`ENVMAP_MODE_REFLECTION`:ks[e.envMapMode]||`ENVMAP_MODE_REFLECTION`}var js={0:`ENVMAP_BLENDING_MULTIPLY`,1:`ENVMAP_BLENDING_MIX`,2:`ENVMAP_BLENDING_ADD`};function Ms(e){return e.envMap===!1?`ENVMAP_BLENDING_NONE`:js[e.combine]||`ENVMAP_BLENDING_NONE`}function Ns(e){let t=e.envMapCubeUVHeight;if(t===null)return null;let n=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(2**n,112)),texelHeight:r,maxMip:n}}function Ps(e,t,n,r){let i=e.getContext(),a=n.defines,o=n.vertexShader,s=n.fragmentShader,c=Es(n),l=Os(n),u=As(n),d=Ms(n),f=Ns(n),p=ds(n),m=fs(a),h=i.createProgram(),g,_,v=n.glslVersion?`#version `+n.glslVersion+`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=$o(i,i.VERTEX_SHADER,y),S=$o(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=as(i,x,`vertex`),n=as(i,S,`fragment`);W(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
